                    ...
                    <table id="example1" class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Tombol Print Nota -->
                                <a
                                    href="pdf/output/nota_jual.php?PenjualanID=<?=$kolom['PenjualanID']; ?>"
                                    target="_blank">
                                    <i class="fas fa-print"></i>
                                </a>
                                <!-- Tombol Informasi -->
                                <a href="index.php?p=infojual&PenjualanID=<?= $kolom['PenjualanID']; ?>">
                                    <i class="fas fa-search"></i>
                                </a>
                                <!-- Tombol Hapus -->
                                <a
                                    href="aksi/penjualan.php?aksi=hapus&PenjualanID=<?=$kolom['PenjualanID']; ?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="aksi/penjualan.php" method="post">
                    ...
                    <input type="text" name="Pelanggan" class="form-control" required="required">

                    <label for="TotalBelanja">Total Belanja</label>
                    <input type="text" name="TotalBelanja" class="form-control" required="required">
