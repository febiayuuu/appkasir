            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-3">
                            <button class="btn btn-block btn-success" type="button" data-toggle="modal" data-target="#cariProduk">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>
                                <a href="aksi/penjualan.php? aksi=hapus-keranjang&ProdukID=<?=$keranjang['ProdukID']; ?>">
